...
#define PARTICLE_SPAWN_AXIS_Y_MAX (45)
#define PARTICLE_SPAWN_AXIS_Y_MIN (30)

#define TITLE_BITMAP_AXIS_X (64)
#define TITLE_BITMAP_AXIS_Y (20)

#define FISH_BITMAP_AXIS_X (12)
#define FISH_BITMAP_AXIS_Y (8)

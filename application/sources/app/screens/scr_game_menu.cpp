...
void menu_seagrass_display()
{
    ...
    view_render.drawBitmap(10, 50, frames[m_seagrass_frame], w, h, WHITE);
    view_render.drawBitmap(54, 54, frames[m_seagrass_frame], w, h, WHITE);
    view_render.drawBitmap(104, 46, frames[m_seagrass_frame], w, h, WHITE);
}
/*-----------------------------Game menu display-----------------------------*/

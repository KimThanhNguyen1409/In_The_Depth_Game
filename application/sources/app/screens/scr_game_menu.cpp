...
void menu_seagrass_display()
{
	...
	if (m_seagrass_frame == 2)
		frame = seagrass_II;
	else if (m_seagrass_frame == 3)
		frame = seagrass_III;
	else if (m_seagrass_frame == 4)
		frame = seagrass_IV;
	else if (m_seagrass_frame == 5)
		frame = seagrass_V;
	else if (m_seagrass_frame == 6)
		frame = seagrass_VI;
	else if (m_seagrass_frame == 7)
		frame = seagrass_VII;

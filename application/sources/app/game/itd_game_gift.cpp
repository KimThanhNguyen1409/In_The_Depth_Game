        ...
        case ITD_GAME_GIFT_SPAWN:
        {
            ...
            else
            {
                for (uint8_t i = 0; i < gift_number; i++)
                {
                    ...
                    do
                    {
                        temp_x = GIFT_SPAWN_AXIS_X_MIN + rand() % (GIFT_SPAWN_AXIS_X_MAX - GIFT_SPAWN_AXIS_X_MIN) +
                                 GIFT_SPAWN_LEFT_OFFSET;
                        temp_y = GIFT_SPAWN_AXIS_Y_MIN + rand() % (GIFT_SPAWN_AXIS_Y_MAX - GIFT_SPAWN_AXIS_Y_MIN) +
                                 GIFT_SPAWN_TOP_OFFSET;
